    ...
    <div className='h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-red-500 lg:flex-row '>
      ...
      <div className='h-1/2 p-4 flex flex-col justify-center overflow-y-scroll lg:h-full lg:w-2/3 2xl:w-1/2 lg:px-20 xl:px-40'>
        ...
        <div className='mt-40 lg:mt-0'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <h2 className='font-bold'>9000</h2>
      ...
      <div className='h-1/2 p-4 bg-fuchsia-50 flex flex-col gap-4 justify-center lg:h-full lg:w-1/3 2xl:w-1/2 lg:px-20 xl:px-40 2xl:text-xl 2xl:gap-6'>
        ...
        <div className='flex justify-between'>
          ...
          <span className='font-bold'>N36000</span>
        </div>
        <button className='bg-red-500 text-white p-3 rounded-md uppercase self-end'>
          Checkout
        </button>
      </div>
    </div>
